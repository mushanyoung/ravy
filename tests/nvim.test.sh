...
assert_file_contains "$rendered_main" "function! s:zellij_start_lock_watch() abort" "ravy.vim includes the zellij lock watcher helper"
...
assert_file_contains "$rendered_main" "autocmd VimEnter * call s:zellij_start_lock_watch()" "ravy.vim starts the zellij lock watcher"
